...
Python port of packages/coding-agent/src/core/resolve-config-value.ts.
Used by auth-storage and model-registry for API key and header resolution.
"""
...
def _execute_command(command_config: str) -> str | None:
    """Execute a shell command config value and cache the result."""
