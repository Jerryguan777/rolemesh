...
class PiBackend:
    ...
    async def start(
        ...
        # Tools are filtered by permission so Pi never sees options it
        # cannot legitimately exercise. See create_rolemesh_tools docstring
        # for the flag→permission map.
