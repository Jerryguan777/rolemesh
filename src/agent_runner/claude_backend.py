...
class ClaudeBackend:
    ...
    async def start(
        ...
        # Register tools by permission so Claude never sees options
        # it cannot legitimately exercise. Defence-in-depth: the tool
        # functions themselves still check permissions at execution
        # time. See create_rolemesh_mcp_server docstring for the
